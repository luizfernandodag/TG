...
\begin{itemize}
	...
	Pode-se dizer, pela natureza do que é um projeto, que a Aprendizagem Baseada em Projeto é um conjunto de aprendizagens interligadas realizadas por meio da Aprendizagem Baseada em Problema, citada anteriomente. Além de todas características da Aprendizagem Baseada em Problemas, a Aprendizagem Baseada em Projetos também oferece ao aluno aprendizagem mais profunda nos seguintes quesitos:
		\subitem \textbf{Desenvolvimento de habilidades para o século 21}:
		 ...
		 \subitem \textbf{Apresentar para o público}:
...
\subsection{Teoria pedagógica de aprendizagem ativa focando na teoria de aprendizagem por masterização }
\label{Masterizacao}
...
\section{Metodologia \textit{Scrum} para desenvolvimento agíl de projetos }
\label{EstudoScrum}
...
\subsection{Metodologia de desenvolvimento de projetos Cascata}
\label{SecCascata}
...
\subsection{Metodologia de desenvolvimento de projetos Scrum}
...
\section{Currículos relacionados a Algoritmos e Programação de Computadores}
...
\subsection{Aprendizagem por mastrização e Scrum adpatados ao curso de Algoritmos e Programação de Computadores}
