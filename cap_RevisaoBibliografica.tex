...
%\resumodocapitulo{Neste capítulo }
 O objetivo deste capítulo é explicitar todos conceitos relevantes deste trabalho relativos a ensino e aprendizagem de Ciências Exatas e Engenharia e a estrutura detalhada da placa Intel\textsuperscript{\textregistered} Galileu. Esses estudos servirão de base para a proposição um modelo de aula de programação básica para estudantes de graduação levando em conta os paradigmas de educação mais eficientes dentre os elencados.
...
\label{PBL}
A aprendizagem ativa é geralmente definida como qualquer método de instrução que envolve os alunos diretamente no processo de aprendizagem. Sob o método de aprendizagem ativa, é demandado dos alunos que eles façam atividades de aprendizzgem significativas e constantemente reflitam sobre o que estão aprendendo, como estão aprendendo, dificuldades no processo e aplicações de tais conhecimentos\cite{Parte2:artigo13}.

Apesar dessa definição poder incluir atividades tradicionais como a lição de casa, na prática, aprendizagem ativa se refere a  a atividades que são introduzidos na sala de aula. O principal elemento da aprendizagem ativa são a atividade dos alunos e seu envolvimento no processo de aprendizagem.

A literatura indica que esse de modo de instrução possui efetividade similar à tradicional com relação a retenção de muitas informações fatuais a serem relembradas em curto espaço de tempo. Por outro lado, se o objetivo é facilitar a retenção de longo prazo, ajudar os estudantes a desenvolverem habilidades de raciocínio e resolução de problemas ou estimulá-los a aprender um conteúdo em específico a aprendizagem ativa é mais efetiva\cite{Parte1:artigo20}. 

A aprendizagem ativa pode ser engredada de diversar formas, mas a mais tradicional é na forma de prática de laboratorio. Segundo \cite{Laboratorio1}, a implementação de práticas laboratorias é importante pelos seguintes quesitos:

\begin{itemize}
	\item Com práticas laboratorias, o estudante aprende a ser um investigador/experimentador.
	\item Por meio do laboratório, o estudante pode solidificar, ampliar e até aprender conceitos além dos propostos.
	\item O laboratório ajuda o estudante a ter discernimento da aplicação dos conceitos aprendidos no mundo real.
\end{itemize}

Os paradigmas mais utilizando na promoção da aprendizagem ativa são os 
seguintes:
...
\begin{enumerate}
	...
	Pode-se dizer, pela natureza do que é um projeto, que a Aprendizagem Baseada em Projeto é um conjunto de aprendizagens interligadas realizadas por meio da Aprendizagem Baseada em Problema, citada anteriomente. Além de todas características da Aprendizagem Baseada em Problemas, a Aprendizagem Baseada em Projetos também oferece ao aluno aprendizagem mais profunda nos seguintes quesitos:
		\subitem \textbf{Desenvolvimento de habilidades para o século 21}:
	
		
		 \subitem \textbf{Desenvolvimento expírito de exploração}:
		 
		  
		 \subitem \textbf{Organizar-se em torno de questões abertas}: 
		 
		 
		 \subitem \textbf{Incluir processos de revisão e reflexão}:
		 
		 
		 \subitem \textbf{Apresentar-se para um público}:
	
\end{enumerate}
		


Os resultados de se utilizar as metodologias de aprendizagem ativa são excelentes \cite{Parte1:artigo6}. Entretanto, a aplicação de tais metodologias é complexa. Alguns dos principal desafio ao se utilizar o paradigma de instrução ativa é conseguir envolver todos estudantes em atividades produtivas sem sacrificar tempo e recursos importantes no ensino dos conteúdos da disciplina em questão.  

\subsection{Aprendizagem por masterização}
\label{Masterizacao}
...
\begin{itemize}
	...
	\item Domínio afetivo, cuja abrangênc{\tiny }ia está ligado aos aspectos de sensibilização, socialização e gradação de valores
...
\subsubsection{Programa desenvolvido em QT para auxílio na definição de objetivos educacionais}
...
\section{Algoritmos e Programação de Computadores}

\subsection{Introdução}

Este capítulo é destinado ao estudo da importância da computação no contexto do ensino e aprendizagem de ciências exatas. É apresentado neste capítulo um breve estudo de currículos das melhores universidades mundiais e as melhores universidades brasileiras. 

Tomando o que foi apresentado nas seções anteriores a este capítulo sobre os efeitos positivos da aprendizagem ativa e suas técnicas de implementação é urgente uma revisão das disciplinas, currículos, métodos de avaliação de forma a incluir formas mais dinâmicas de ensino e aprendizagem.
...
Pesquisou-se o currículo da UnB e o currículo da universidade \textit{California Institute of Tecnology} para disciplinas com ementa similar ao de \textit{Algoritmos e Programação de Computadores}. O resultado de tal pesquisa é mostrado na tabela \ref{tabRakingUniversidades2}. 

Fez, também, uma pesquisa mais aprofundada do conteúdo programático de tais disciplinas. O resultado de tal pesquisa é mostrado na tabela \ref{tabRakingUniversidades3}.
...
A disciplina proposta seguirá a ementa proposta na tabela \ref{ementa}. Na ementa antiga, na qual está se baseia, a proporção entre horas de aulas teóricas e práticas é de 4 para 2 horas. Foi proposta a troca para 4 horas de atividades práticas e 2 horas de atividades teóricas. 

As atividades práticas não devem ser apenas laboratórias, mas devem contemplar, também, os seguintes aspectos relativos a gerência de projetos seguindo a metodologia Scrum:

\begin{enumerate}
	\item Reuniões das equipes Scrum formadas pelos alunos para:
		\subitem  Atualização do quadro de atividades Scrum (\textit{Scrum Backlog}).
		\subitem  Reuniões de revisão de \textit{Sprint}
		\subitem  Aprendizagem colaborativa.
		\subitem  Desenvolvimento de projetos propostos.
		\subitem  Reuniões com o professor que atuará como \textit{Scrum Master}. 
\end{enumerate}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|}
		\hline
		\multicolumn{2}{|c|}{\textbf{CIC - Computação básica e tópicos em aprendizagem ativa e eletrônica}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        \\ \hline
		\textbf{Créditos}       & 6 (Teoria:2, Prática:4), $1^{0}$ período                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \\ \hline
		\textbf{Ementa}         & \begin{tabular}[c]{@{}c@{}}Estudo dos seguintes tópicos de computação:\\ 1)Histórico da computação. Sistemas de numeração.\\  2)Arquitetura de Computadores.Linguagens formais.\\  3)Algoritmos e programas. Programação estruturada.\\ 4) Identificadorese tipos.\\  5)Operadores e expressões. \\ 6)Estruturas de controle: condicional e repetição.\\ 7)Entrada e saída de dados. \\ 8)Estruturas de dados estáticas:\\  9)agregados homogêneose heterogêneos.\\ 10) Iteração e recursão.\\ 11) Subalgoritmos.\\  12)Implementação de soluções\\ utilizando o fragmento estruturado\\  de uma linguagem de programação\\ \\ Aplicando os seguintes conceitos de eletrônica básica:\\ 1)Circuitos\\ 2)Resistores e Capacitores\\ 3)Lei de Ohm\\ 4) Leis de Kirschoof\\ 5)Sensores\\ 6) Interruptores\\ 7) Programação de microcontroladores baseados\\ em Arduino\end{tabular} \\ \hline
		...
		\textbf{Pré-requisitos} & Sem pré-requisitos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \\ \hline
	\end{tabular}
\end{table}
...
\begin{enumerate}
	...
	\item Definir os objetivos educacionais na forma \textit{de características de produto} utilizando a taxonomia de Bloom para criar as \textit{User Stories} e \textit{Epics} e definir os critérios de aprovação para cada objetivo de masterização.
...
\subsection{Aprendizagem por masterização e Scrum adaptados ao curso de Algoritmos e Programação de Computadores}
...
\subsection{Proposta de uso de placas de prototipagem eletrônica}

O uso da metodologia de aprendizagem por masterização, seja ela pelo vies do uso da metodologia classica de ensino, pelo uso da metodologia  de Aprendizagem Baseada em Problemas ou pelo vies da Aprendizagem Baseada em Projetos citadas na seção \ref{PBL}, tem sido feito, progressivamente mais, usando placas de prototipagem eletrônica. 

No caso citado em \cite{aprendizagemAtivaArduino}, os alunos estavam em início de curso e passaram por uma revisão de modelo de curso. Nessa revisão, foi incluído o uso da placa Arduino para aprendizagem de programação básica. Os alunos que estudaram sob o novo formato, comparados a turmas anteriores, tiveram níveis mais altos de aprendizagem e retenção do conhecimento.

Já em \cite{Laboratorio2}, foi proposto, para alunos de ensino médio, um projeto de ensinode robótica baseado em aprendizagem ativa pelo vies da Aprendizagem Baseada em Projetos. Nesse caso citado, foram utilizadas placas Arduino, por causa da sua facilidade de programação e prototipação, o que a tem feito progressivamente mais popular. 

Assim como em \cite{aprendizagemAtivaArduino}, em \cite{Laboratorio2} as práticas proposta melhoram consideravelmente os índices acadêmicos dos estudantes, assim como sua motivação a aprender e retenção do conhecimento exposto.
    
No caso desta proposta para a disciplina \textit{Algoritmos e Programação de Computadores}, escolheu-se o uso da Placa Intel\textsuperscript{\textregistered} Galileo. 

A placa  Intel\textsuperscript{\textregistered} Galileo, além de possuir todas funcionalidades da placa Arduino supracitada, tem funcionalidades mais diversas as quais permitem a ampliação dos conteúdos tratados não só para cursos de programação básica, mas para as mais diversas disciplinas de computação. 

\subsection{Forma de avaliação}

Como a metodologia de ensino proposta é distinta da metologia clássica , centrada no professor, deve ser também distinta a forma de avaliação dos alunos.

Levando em consideração as teorias expostas nas seção \ref{Masterizacao}, \ref{PBL} e \ref{EstudoScrum} deve ser parte majoritária das avaliações os seguintes aspectos:

\begin{itemize}
	\item Masterização dos conteúdos propostos prática a prática proposta
	\item Masterização de habilidades de trabalho em grupo por meio de:
		\subitem Auto-avaliação
		\subitem Peer-review (Avaliação dos outros integrantes do grupo)
	\item Quantidade e Qualidade dos \textit{Entregáveis} de cada Sprint
	\item Qualidade dos trabalhos solicitados, não apenas com relação ao produto final, mas com relação também a:
		\subitem Apresentação 
		\subitem Documentação apresentada
\end{itemize}


Além disso, é totalmente de acordo com o proposto  na teoria de masterização se houver alguma forma de avaliação, pontuação e premiação aos alunos mais engajados em processos de aprendizagem colaborativa.

As percentagens de cada dos critérios sugerido na nota final dos alunos deve ser decidida a critério do professor, o qual está agindo no papel de orientador e \textit{Scrum Master}.
