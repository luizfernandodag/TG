...
\begin{figure}[H]
	...
	\caption{Percentagem dos conteúdos tratados na UnB e \textit{California Insitute of Tecnology} que podem ser ensinados utilizando a placa Galileo}
...
\subsection{Estudo da metodologia SCRUM para desenvolvimento agíl de projetos }
\label{EstudoScrum}
...
\subsubsection{Adaptação dos princípios e fluxo metodologia Scrum à disciplina \textit{Algoritmos e Programação de Computadores}}
...
A seguinte enumeração mostra uma possível especificação de cada um dos módulos de aprendizagem definidos anteriormente seguindo a \textit{Taxonomia e Bloom}:
\begin{enumerate}
	\item O histórico da computação
