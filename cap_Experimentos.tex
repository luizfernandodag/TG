...
A expressão \textit{RC} da equação \ref{eqCap8} indica quanto tempo o capacitor leva para carregar. Quando o tempo tende para o infinito, o capacitor num circuito RC tende a se comportar como um circuito aberto. A tensão sobre o capacitor tende a tensão de alimentação e a corrente tende a zero, ou seja, 
...
\subsection{Funções Avançadas - Arduino}
...
Timer1.attachInterrupt( ISR_EXEMPLO ); //Vincula a ISR
